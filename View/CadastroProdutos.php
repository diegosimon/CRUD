...
<html lang="pt-br">
    <head>
        <title>CRUD - Cadastrar Produtos</title>
        <meta charset="utf-8">
        ...
        <div class="container-fluid">
            <div class="row content">
                ...
                <div class="col-sm-9">
                    ...
                    <hr>
                    <h2>Produtos</h2>
                    <form action="../bean/BeanCadProdutos.php" method="POST" id="formulario" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Código:</label>
                                        <input name="codigo" id="codigo" type="text" class="form-control" placeholder="Código do Produtos...">
                                    </div>
                                    <div class="form-group">
                                        <label>Quantidade em Estoque:</label>
                                        <input name="qtdestoque" id="qtdestoque" type="text" onkeyup="numeros(this);" class="form-control" placeholder="Quantidade em Estoque...">
                                    </div>                            
                                    <div class="form-group">
                                        <label>Preço de Custo:</label>
                                        <input name="custo" id="custo" type="text" onkeyup="numeros(this);" maxlength="9" class="form-control" placeholder="Custo do Produto...">
                                    </div>
                                </div><!-- /.End Colum Esquerda -->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Descricão:</label>
                                        <input name="descricao" id="descricao" type="text" class="form-control" placeholder="Descricão do Produtos...">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="venda" id="venda" type="text" onkeyup="numeros(this);" class="form-control" placeholder="Preço de Venda...">
                                    </div>
                        ...
                        <div class="box-footer">
                            ...
                            <input type="button" onclick="validarDados();" value="Cadastrar" class="btn btn-success"></input>
                        </div>
                    </form>
                </div>
            </div>
